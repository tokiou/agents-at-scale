...
CREATE TABLE fare_classes (
    ...
    change_fee NUMERIC(12, 2) NOT NULL,
...
CREATE TABLE travel_credits (
    ...
    currency CHAR(3) NOT NULL,
    status travel_credit_status NOT NULL,
...
CREATE TABLE flight_changes (
    ...
    old_fare_class_id UUID NOT NULL REFERENCES fare_classes(id),
    new_fare_class_id UUID NOT NULL REFERENCES fare_classes(id),
    fare_difference NUMERIC(12, 2) NOT NULL,
    change_fee NUMERIC(12, 2) NOT NULL,
    travel_credit_used NUMERIC(12, 2) NOT NULL,
    currency CHAR(3) NOT NULL,
    created_at TIMESTAMPTZ NOT NULL
);
